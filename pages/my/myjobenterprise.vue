<template>
	<view class="pageContent">
		<uni-nav-bar title="职位管理" dark :fixed="true" shadow background-color="#007AFF" status-bar left-icon="left"
			...
			<view style="display: flex;flex-direction:row;font-size: 20px;">
				<view
					...
					<view style="display: flex;flex-direction:column;">
						...
						<view style="margin-top: 10px;">在招岗位</view>
					</view>
				</view>
				<view
					style="-webkit-flex: 1;flex: 1;display: flex;height: 100px; justify-content: center; align-items: center; ">
				...
				<view
					...
					<view style="margin-top: 10px;">
						<button type="primary" style="background-color: white;color: #007aff;">发布招聘</button>
					</view>
				</view>
			</view>
		</view>
							...
							<view v-if="item.isFold">
								<view v-for="(item,index1) in item.clist" :key="index1" style="display: flex;flex-direction:row;
									...
									<view class="" style="display: flex;flex-direction:column;margin-left: 3px;">
										...
										<view  style="font-size: 10px;">预约时间：{{item.creationTime}}</view>
									</view>
									<view class="" style="margin-left: 20px;margin-top: 6px;">
					...
					<block v-for="(item,index) in list" :key="index">
						<view class="" style="
							...
							<view v-if="item.isFold">
								...
								background-color: #007aff;border-radius: 50px;margin-top: 6px;"></view>
									<view class="" style="display: flex;flex-direction:column;margin-left: 3px;">
										<view style="font-size: 10px;">{{item.company}}</view>
										<view style="font-size: 10px;">预约时间：{{item.creationTime}}</view>
									</view>
